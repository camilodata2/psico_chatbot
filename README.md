...
- **Entrada Multimodal:**  
   Recibe texto, imágenes y audio para generar respuestas precisas.

- **Traducción y Detección de Idioma:**  
   Detecta automáticamente el idioma y traduce las respuestas según sea necesario.

- **Contexto y Memoria:**  
   Utiliza **ChromaDB** para almacenar y recuperar contexto de conversaciones anteriores.

- **Generación de Respuestas con Ollama:**  
   Utiliza un modelo robusto a través de Ollama para generar respuestas contextuales y precisas.
